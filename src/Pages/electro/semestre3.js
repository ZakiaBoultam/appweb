...
const ElectromécaniqueSemestre3 = () => { // Renommez la fonction pour correspondre à l'exportation attendue
  ...
  <ProposerCours filiere="Electromécanique" niveau="Semestre 3" courses={courses} />
</div>
...
export default ElectromécaniqueSemestre3;
